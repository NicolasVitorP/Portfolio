            ...
            <div className="flex flex-col md:flex-row items-center gap-12 mt-8">
                ...
                <div className="w-full md:w-1/3 flex justify-center">
                    <div className="relative w-64 h-64 md:w-80 md:h-80">
                        <div className="absolute inset-0 bg-gradient-to-tr from-primary to-purple-500 rounded-full opacity-20 blur-md"></div>
                        <div className="absolute inset-0 border-2 border-white/10 rounded-full"></div>
                        <div className="relative w-full h-full bg-gray-800 rounded-full overflow-hidden shadow-2xl flex items-center justify-center border border-white/5">
                            <img
                                src={profileImg}
                                alt="Profile"
